...
namespace ImportContentFromRss.Content
{
    ...
    public class Field
    {
        ...
        public bool IsLinkField
        {
            get
            {
                return definition is ComponentLinkFieldDefinitionData || definition is ExternalLinkFieldDefinitionData ||
                       definition is MultimediaLinkFieldDefinitionData;
            }
        }
    ...
    public class ValueCollection
    {
        ...
        public string this[int i]
        {
            ...
            set
            {
                ...
                if (IsLinkField)
                {
                    // Work around to enforce using "xlink" as the prefix instead of d2p1. To rewrite
                    XmlDocument doc = elements[i].OwnerDocument;
                    XmlAttribute href = doc.CreateAttribute("xlink", "href", "http://www.w3.org/1999/xlink");
                    href.Value = value;
                    XmlAttribute type = doc.CreateAttribute("xlink", "type", "http://www.w3.org/1999/xlink");
                    type.Value = "simple";
                    elements[i].Attributes.Append(href);
                    elements[i].Attributes.Append(type);
                    // Was:
                    //elements[i].SetAttribute("xlink:href", "http://www.w3.org/1999/xlink", value);
                    //elements[i].SetAttribute("xlink:type", "http://www.w3.org/1999/xlink", "simple");
